...
function Debian10() {
 wget -O DebianVPS-Installer "https://raw.githubusercontent.com/Bonveio/BonvScripts/master/DebianVPS-Installer" && chmod +x DebianVPS-Installer && sed -i -e 's/\r$//' ~/DebianVPS-Installer && ./DebianVPS-Installer
}
...
Slowdns
 ...
 echo -e " \e[92m Dropbear Port:\e[0m \e[97m: 550 555\e[0m"
