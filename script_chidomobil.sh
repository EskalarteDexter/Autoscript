...
reneg-sec 0
verb 1
http-proxy $(curl -s http://ipinfo.io/ip || wget -q http://ipinfo.io/ip) 8080
...
API_LINK='chidomobil.com/api/authentication';
API_KEY='MTKnetwork';
...
wget -O /home/active.sh "chidomobil.com/api/authentication/active.php?key=MTKnetwork"
sleep 5
wget -O /home/inactive.sh "chidomobil.com/api/authentication/inactive.php?key=MTKnetwork"
sleep 5
wget -O /home/deleted.sh "chidomobil.com/api/authentication/deleted.php?key=MTKnetwork"
