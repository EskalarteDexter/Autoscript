...
#Stunnel Port
Stunnel_Port1='443' #Dropbear ssl
Stunnel_Port2='445' #Openssh ssl
Stunnel_Port3='587' #Opemvpn ssl
...
if [[ "$ID" != 'debian' ]]; then
 ...
 # Configure Webmin
 echo -e "\033[0;35mConfiguring InstWebmin...\033[0m"
  fun_bar InstWebmin
 ...
 # Installing SSL Rsa
 echo -e "\033[0;35mInstalling SSL RSA...\033[0m"
  fun_bar Installssl
 ...
 echo -e " \e[92m OpenVPN:\e[0m \e[97m$OpenVPN_Tcp (tcp), $OpenVPN_Udp (udp)\e[0m"
